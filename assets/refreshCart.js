function refreshStaingardDrawer() {
    ...
    fetch(location.href)
      ...
      .then((html) => {
        ...
        const newCartDrawer = tempDoc.querySelector('#Drawer-Staingard .drawer__wrapper');
        const cartDrawer = document.querySelector('#Drawer-Staingard .drawer__wrapper');
        ...
        if (cartCountBubble) {
          fetch(location.href)
            ...
            .then((html) => {
              const tempDoc = document.createElement('div');
              tempDoc.innerHTML = html;
              const newCartCountBubble = tempDoc.querySelector('.cart-count-bubble');
